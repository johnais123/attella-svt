...
TC2
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Loss of Frame
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Loss of Frame  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC3
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Loss of Multiframe
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Loss of Multiframe  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC4
  [Documentation]  Test BDI alarm raised/clear on OTU4 client port
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Backward Defect Indication
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Backward Defect Indication  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC5
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Incoming Alignment Error
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Incoming Alignment Error  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC6
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Backward Incoming Alignment Error
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Backward Incoming Alignment Error  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC7
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Trail Trace Identifier Mismatch
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Trail Trace Identifier Mismatch  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC12
    ...
    Log              Verify Interfaces In Traffic Chain Are Alarm Free
    Wait Interfaces In Traffic Chain Are Alarm Free   
...
TC17
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Degraded defect
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client otu intf}  Degraded defect  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC18
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Alarm Indication Signal
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Alarm Indication Signal  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC19
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Open Connection Indication
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Open Connection Indication  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC20
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Locked
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  ODU Locked  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC21
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  Backward Defect Indication
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  Backward Defect Indication  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC22
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  Trail Trace Identifier Mismatch
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
    ...
    @{alarmNotification}=  Create List  alarm-notification  ${client intf}  Trail Trace Identifier Mismatch  clear
    @{alarmNotifications}=  Create List  ${alarmNotification}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
...
TC27
    ...
    @{alarmNotification1}=  Create List  alarm-notification  ${client intf}  Loss of Frame
    @{alarmNotification2}=  Create List  alarm-notification  ${client intf}  Degraded defect
    ...
    @{alarmNotification1}=  Create List  alarm-notification  ${client intf}  Loss of Frame  clear
    @{alarmNotification2}=  Create List  alarm-notification  ${client intf}  Degraded defect  clear
    @{alarmNotifications}=  Create List  ${alarmNotification1}  ${alarmNotification2}
    Notifications Should Raised  ${ncHandle}  ${alarmNotifications}
